...
<body>
	...
	<span><marquee>This is Laptop mangement system. Lab opens at 8:00 AM and close at 4:00 PM</marquee></span><br><br>
		<center><h4>Issue Laptop</h4><br></center>
		<div class="row">
			<div class="col-md-4"></div>
			<div class="col-md-4">
				<form action="" method="post">
					<div class="form-group">
						<label for="book_name">Laptop Name:</label>
						<input type="text" name="book_name" class="form-control" required>
					</div>
					<div class="form-group">
						<label for="book_author">Faculty Name:</label>
					...
					<div class="form-group">
						<label for="book_no">Laptop Number:</label>
					...
					<button type="submit" name="issue_book" class="btn btn-primary">Issue Laptop</button>
				</form>
			</div>
			<div class="col-md-4"></div>
		</div>
